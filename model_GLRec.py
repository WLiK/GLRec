...
def set_args():
    ...
    parser.add_argument('--train_path', default='/code/bigmodel/code_q/zhengzhi/graph_train_large.json', type=str, help='')
    parser.add_argument('--val_path', default='/code/bigmodel/code_q/zhengzhi/graph_valid_large.json', type=str, help='')
    parser.add_argument('--model_dir', default="/code/bigmodel/code_q/bella_merge/", type=str, help='')
